...
import 'package:weatherapp01/api.dart';
import 'package:weatherapp01/weathermodel.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  _getWeatherData(String location) async {
    ...
    try {
      response = await WeatherApi().geturrentWeather(location);
    } catch (e) {
      setState(() {
